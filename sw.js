...
const SHELL = ['./', './desk.html', './workflows.json', './js/work.js', './js/providers.js', './js/stamps.js', './manifest.webmanifest',
...
self.addEventListener('fetch', e => {
  ...
  e.respondWith(
    fetch(e.request)
      ...
      .catch(() => caches.match(e.request).then(m => m || caches.match('./desk.html')))
  );
});
